...
export default function DashboardPage() {
  ...
  const [guardrails, setGuardrails] = useState({ warnings: [], status: "clear" });
  ...
  return (
    <div className="p-6 max-w-[1400px]">
      ...
      {/* Guardrail Alerts */}
      <GuardrailsPanel warnings={guardrails.warnings} status={guardrails.status} />
