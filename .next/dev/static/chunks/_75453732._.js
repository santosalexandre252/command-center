...
"[project]/app/power/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ZoneDistribution({ activities, ftp }) {
    ...
    const zoneData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ZoneDistribution.useMemo[zoneData]": ()=>{
            ...
            let totalTime = 0;
            activities.forEach({
                "ZoneDistribution.useMemo[zoneData]": (activity)=>{
...
_s(ZoneDistribution, "oXSPuXyhZmv5xTTtZjepwYVDeS4=");
_c2 = ZoneDistribution;
function PowerPage() {
    _s1();
    ...
    const ftpProgression = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PowerPage.useMemo[ftpProgression]": ()=>{
            if (!activities) return [];
            // Group activities by month and find max power efforts
            const monthlyMax = {};
            activities.forEach({
                "PowerPage.useMemo[ftpProgression]": (activity)=>{
            ...
            return Object.values(monthlyMax).sort({
                "PowerPage.useMemo[ftpProgression]": (a, b)=>a.month.localeCompare(b.month)
            }["PowerPage.useMemo[ftpProgression]"]).map({
                "PowerPage.useMemo[ftpProgression]": (item)=>({
    ...
    const powerCurve = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PowerPage.useMemo[powerCurve]": ()=>{
            if (!activities) return [];
            // Collect all power data points
            const allPowerData = [];
            activities.forEach({
                "PowerPage.useMemo[powerCurve]": (activity)=>{
                    if (activity.type === "Ride" && activity.power_curve) {
                        ...
                        try {
                            ...
                            if (Array.isArray(curve)) {
                                curve.forEach({
                                    "PowerPage.useMemo[powerCurve]": (point)=>{
            ...
            return Object.entries(durationGroups).sort({
                "PowerPage.useMemo[powerCurve]": ([a], [b])=>parseInt(a) - parseInt(b)
            }["PowerPage.useMemo[powerCurve]"]).map({
                "PowerPage.useMemo[powerCurve]": ([duration, power])=>({
                        duration: parseInt(duration),
                        power: Math.round(power),
                        durationLabel: duration < 60 ? `${duration}s` : duration < 3600 ? `${Math.round(duration / 60)}m` : `${Math.round(duration / 3600)}h`
                    })
            }["PowerPage.useMemo[powerCurve]"]).filter({
                "PowerPage.useMemo[powerCurve]": (point)=>point.duration >= 30 && point.duration <= 3600
            }["PowerPage.useMemo[powerCurve]"]); // 30s to 1 hour
        }
    }["PowerPage.useMemo[powerCurve]"], [
        activities
    ]);
    const wkData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PowerPage.useMemo[wkData]": ()=>{
            if (!activities || !athlete?.weight) return [];
            return activities.filter({
                "PowerPage.useMemo[wkData]": (a)=>a.type === "Ride" && a.average_watts && a.moving_time
            }["PowerPage.useMemo[wkData]"]).sort({
                "PowerPage.useMemo[wkData]": (a, b)=>new Date(b.start_date_local) - new Date(a.start_date_local)
            }["PowerPage.useMemo[wkData]"]).slice(0, 20).reverse().map({
                "PowerPage.useMemo[wkData]": (activity)=>({
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$recharts$40$2$2e$15$2e$4_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$recharts$2f$es6$2f$component$2f$ResponsiveContainer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ResponsiveContainer"], {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$recharts$40$2$2e$15$2e$4_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$recharts$2f$es6$2f$chart$2f$LineChart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LineChart"], {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$recharts$40$2$2e$15$2e$4_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$recharts$2f$es6$2f$component$2f$Tooltip$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Tooltip"], {
                                                    content: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PowerCurveTooltip, {}, void 0, false, {
                                                        fileName: "[project]/app/power/page.js",
                                                        lineNumber: 291,
                                                        columnNumber: 35
                                                    }, void 0)
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_react$2d$dom$40$18$2e$3$2e$1_react$40$18$2e$3$2e$1_$5f$react$40$18$2e$3$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ZoneDistribution, {
...
_s1(PowerPage, "MWfDb/Lys3BF76IVYQrRoRDkkr0=");
_c3 = PowerPage;
var _c, _c1, _c2, _c3;
__turbopack_context__.k.register(_c, "ChartTooltip");
__turbopack_context__.k.register(_c1, "PowerCurveTooltip");
__turbopack_context__.k.register(_c2, "ZoneDistribution");
__turbopack_context__.k.register(_c3, "PowerPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_75453732._.js.map